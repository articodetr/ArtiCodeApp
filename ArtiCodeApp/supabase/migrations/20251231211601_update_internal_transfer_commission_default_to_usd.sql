/*
  # Update Internal Transfer Function Commission Default to USD

  1. Changes
    - Update create_internal_transfer function to use USD as default commission currency instead of YER
    - Maintains all existing functionality
  
  2. Notes
    - This only affects the default parameter value
    - Users can still specify any currency when calling the function
*/

-- Update the function with USD as default commission currency
