/*
  # إصلاح رقم الحركة المرآة - توليد رقم فريد

  ## المشكلة
  الحركة المرآة تحاول استخدام نفس movement_number الأصلي مما يسبب خطأ unique constraint.

  ## الحل
  تعديل دالة create_mirror_movement_v2 لتوليد رقم حركة جديد وفريد للحركة المرآة.
*/
...
COMMENT ON FUNCTION create_mirror_movement_v2 IS 'إنشاء حركة مرآة مع رقم حركة فريد وإنشاء العميل المقابل تلقائياً';
