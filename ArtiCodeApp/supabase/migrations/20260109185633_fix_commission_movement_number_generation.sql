/*
  # إصلاح توليد رقم الحركة للعمولات

  ## المشكلة
  حركات العمولة لا تحتوي على movement_number مما يسبب خطأ not-null constraint.

  ## الحل
  تحديث trigger ليولد movement_number لحركات العمولة.
*/
