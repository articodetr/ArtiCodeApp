/*
  # إصلاح trigger العمولة - استخدام AFTER INSERT

  ## المشكلة
  الـ trigger يحاول إدراج حركة العمولة مع related_commission_movement_id = NEW.id
  ولكن NEW.id لم يتم إضافته بعد في الجدول.

  ## الحل
  تغيير الـ trigger إلى AFTER INSERT بدلاً من BEFORE INSERT.
*/
...
-- استخدام AFTER INSERT بدلاً من BEFORE INSERT
