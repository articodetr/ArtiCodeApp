/*
  # إصلاح دالة create_internal_transfer - إضافة أرقام الحركات

  ## المشكلة
  الدالة لا تولد movement_number للحركات الجديدة.

  ## الحل
  إضافة توليد movement_number لكل حركة (المرسل والمستلم).
*/
